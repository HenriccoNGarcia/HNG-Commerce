...
class HNG_Admin_Settings {
    ...
    private function register_default_tabs() {
        ...
        if (class_exists('HNG_Cart_Layouts_Settings')) {
            $this->register_tab('layouts', __('Layouts', 'hng-commerce'), [HNG_Cart_Layouts_Settings::class, 'render_tab']);
        }
            ...
            <h2 style="display: inline-flex; align-items: center;">
                ...
                <?php echo hng_admin_tooltip(
                    ...
                    [
                        ...
                        'items' => [
                            ['label' => 'Brasil', 'text' => 'Use BRL, símbolo antes, milhar "." e decimal ","'],
                            ['label' => 'Internacional', 'text' => 'Use USD/EUR conforme o público-alvo'],
                        ]
                    ]
                ); ?>
            </h2>
            ...
            <h2 style="display: inline-flex; align-items: center;">
                ...
                <?php echo hng_admin_tooltip(
                    ...
                    [
                        ...
                        'items' => [
                            ['label' => 'Opção 1', 'text' => 'Crie páginas e adicione os shortcodes acima'],
                            ['label' => 'Opção 2', 'text' => 'Use Elementor e adicione o widget HNG correspondente'],
                            ['label' => 'Passo final', 'text' => 'Selecione as páginas aqui nas configurações'],
                        ]
                    ]
                ); ?>
            </h2>
            ...
            <h2 style="display: inline-flex; align-items: center;">
                ...
                <?php echo hng_admin_tooltip(
                    ...
                    [
                        'title' => '⚠️ Importante',
                        'items' => [
                            ['label' => 'Webhook Secret', 'text' => 'Copie do painel do gateway e cole aqui'],
                            ['label' => 'URL Webhook', 'text' => 'Configure no gateway a URL mostrada abaixo'],
                        ]
                    ]
                ); ?>
            </h2>
            ...
            <h2 style="display: inline-flex; align-items: center;">
                ...
                <?php echo hng_admin_tooltip(
                    ...
                    [
                        'title' => '💡 Recomendação',
                        'items' => [
                            ['label' => 'Loja tradicional', 'text' => 'Ative Simples e/ou Variável'],
                            ['label' => 'Infoprodutos', 'text' => 'Ative Digital + Assinatura'],
                            ['label' => 'Prestador de serviço', 'text' => 'Ative Orçamento + Agendamento'],
                        ]
                    ]
                ); ?>
            </h2>
            ...
            <h2 style="display: inline-flex; align-items: center;">
                ...
                <?php echo hng_admin_tooltip(
                    ...
                    [
                        ...
                        'items' => [
                            ['label' => 'Produtos digitais', 'text' => 'Prazo de 7 dias (CDC brasileiro)'],
                            ['label' => 'Produtos físicos', 'text' => 'Prazo de 7 a 30 dias'],
                            ['label' => 'Serviços', 'text' => 'Avalie caso a caso (manual)'],
                        ]
                    ]
                ); ?>
            </h2>
            ...
            <h2 style="display: inline-flex; align-items: center;">
                ...
                <?php echo hng_admin_tooltip(
                    ...
                    [
                        'title' => '🎯 Quando Usar',
                        'items' => [
                            ['label' => 'Vantagem', 'text' => 'Sem taxas de cartão (você recebe 100%)'],
                            ['label' => 'Ideal para', 'text' => 'Cursos, consultorias, serviços de alto valor'],
                            ['label' => 'Cuidado', 'text' => 'Maior risco de inadimplência vs cartão'],
                        ]
                    ]
                ); ?>
            </h2>
