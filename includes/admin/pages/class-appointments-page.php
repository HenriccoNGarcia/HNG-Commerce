        ...
        if (function_exists('hng_admin_tooltip')) {
            echo hng_admin_tooltip(
                ...
                [
                    'title' => '💡 Dica',
                    'items' => [
                        ['label' => 'Produtos', 'text' => 'Configure horários e profissionais no produto tipo Agendamento'],
                        ['label' => 'Profissionais', 'text' => 'Somente profissionais ativos aparecem para seleção'],
                    ]
                ]
            );
        }
