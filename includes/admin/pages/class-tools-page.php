        ...
        if (function_exists('hng_admin_tooltip')) {
            echo hng_admin_tooltip(
                ...
                [
                    'title' => '⚠️ Importante',
                    'items' => [
                        ['label' => 'Backup', 'text' => 'Sempre faça backup antes de migrações'],
                        ['label' => 'CSV', 'text' => 'Use UTF-8 e vírgula como separador'],
                        ['label' => 'Tabelas', 'text' => 'Recriar tabelas preserva dados existentes'],
                    ]
                ]
            );
        }
