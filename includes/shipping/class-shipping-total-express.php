...
class HNG_Shipping_Total_Express extends HNG_Shipping_Method {
	...
	public function get_settings() {
		return array(
			...
			'services'       => (array) $this->get_option( 'services', array( 'ecommerce' ) ),
	...
	public function calculate_shipping( $package ) {
		...
		if ( is_array( $hooked_rates ) ) {
			return array_map( array( $this, 'format_rate' ), $this->normalize_rates( $hooked_rates, $settings ) );
		}
 ...
 */
add_filter(
	'hng_shipping_total_express_create_label',
	function ( $result, $order, $selected_rate, $settings ) {
...
add_filter(
	'hng_shipping_total_express_track',
	function ( $result, $tracking_code, $settings ) {
