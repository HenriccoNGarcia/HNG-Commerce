                ...
                if (function_exists('hng_admin_tooltip')) {
                    echo hng_admin_tooltip(
                        ...
                        [
                            'title' => '💡 Dica',
                            'items' => [
                                ['label' => 'Ordem', 'text' => 'Configure dimensões padrão primeiro'],
                                ['label' => 'Múltiplas', 'text' => 'Ative várias transportadoras simultaneamente'],
                                ['label' => 'Teste', 'text' => 'Use ambiente sandbox antes de produção'],
                            ]
                        ]
                    );
                }
