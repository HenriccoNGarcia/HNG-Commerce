...
(function($) {
    ...
    const HNGLiveChat = {
        ...
        startSSE: function() {
            ...
            this.eventSource.addEventListener('messages', function(e) {
                const data = JSON.parse(e.data);
                debugLog('Live Chat: SSE messages received', data);
                self.processNewMessages(data.messages);
            });
            
            this.eventSource.addEventListener('session_closed', function(e) {
                debugLog('Live Chat: SSE session closed');
                self.handleSessionClosed();
                self.stopPolling();
            });
            
            this.eventSource.addEventListener('operator_typing', function(e) {
                const data = JSON.parse(e.data);
                if (data.typing) {
        ...
        showTypingIndicator: function() {
            ...
            this.hideTypingTimeout = setTimeout(function() {
